...
type IComponent<'P,'S> =
        ...
        abstract children: ReactElement array with get, set
        abstract state: 'S with get, set
        abstract setState: 'S -> unit 

        abstract setState: ('S->'P->'S)->unit

        abstract setInitState: 'S->unit

        abstract forceUpdate: (unit->unit)->unit

        abstract isMounted: bool 
...
type IPureComponent<'P,'S> =
    inherit IComponent<'P,'S>

/// An abstract component that Blueprint components can extend
/// in order to add some common functionality like runtime props validation.
type AbstractComponent<'P, 'S> =
    inherit IComponent<'P, 'S>
...
/// An abstract component that Blueprint components can extend
/// in order to add some common functionality like runtime props validation.
type AbstractPureComponent<'P, 'S> =
    inherit IPureComponent<'P, 'S>
    abstract displayName: obj with get, set
    abstract timeoutIds: obj with get, set
    abstract componentWillReceiveProps: nextProps: obj -> unit
    abstract componentWillUnmount: unit -> unit
...
type IActionProps =
    ...
    abstract icon: U2<IconName, ReactElement> option with get, set
    /// Click event handler. 
...
type IKeyWhitelist<'T> =
    abstract ``include``: Array<obj> with get, set

type IKeyBlacklist<'T> =
...
//     abstract getDisplayName: ComponentClass: U2<IComponentType, INamed> -> string
//     abstract isElementOfType: element: obj option * ComponentClass: IComponentType<'P> -> bool
...
type IThrottledReactEventOptions =
    abstract preventDefault: bool option with get, set

//     /// Show the given menu element at the given offset from the top-left corner of the viewport.
//     /// The menu will appear below-right of this point and will flip to below-left if there is not enough
//     /// room onscreen. The optional callback will be invoked when this menu closes.
//     abstract show: menu: ReactElement * offset: IOffset * ?onClose: (unit -> unit) * ?isDarkTheme: bool -> unit
...
type IIconProps =
    ...
    /// - If given a `ReactElement`, that element will be rendered and _all other
    ///    props on this component are ignored._ This type is supported to
    ///    simplify icon support in other Blueprint components. As a consumer, you
    ///    should avoid using `<Icon icon={<Element />}` directly; simply render
    ///    `<Element />` instead.
    abstract icon: U3<IconName, ReactElement, obj> option with get, set
...
type IOverlayableProps =
    ...
    abstract onClose: (React.SyntheticEvent-> unit) option with get, set
...
type Overlay =
    inherit IComponent<IOverlayProps, IOverlayState>
    abstract displayName: string with get, set
...
type IAlertProps =
    ...
    abstract onCancel: ?evt: React.SyntheticEvent -> unit
    ...
    abstract onConfirm: ?evt: React.SyntheticEvent -> unit
    ...
    abstract onClose: confirmed: bool * ?evt: React.SyntheticEvent-> unit
...
type IButtonProps =
    ...
    abstract rightIcon: U2<IconName, ReactElement> option with get, set
...
type AbstractButton<'H> =
    inherit IComponent<obj, IButtonState>
    ...
    abstract handleKeyDown: (React.KeyboardEvent -> unit) with get, set
    abstract handleKeyUp: (React.KeyboardEvent -> unit) with get, set
...
type Button =
    inherit AbstractButton<React.ButtonHTMLAttributes>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement


type AnchorButton =
    inherit AbstractButton<React.AnchorHTMLAttributes>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type ButtonGroup =
    inherit IPureComponent<IButtonGroupProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type Callout =
    inherit IPureComponent<ICalloutProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type Card =
    inherit IPureComponent<ICardProps>
    abstract displayName: string with get, set
...
type Collapse =
    ...
    abstract render: unit -> React.ReactElement
    abstract componentDidMount: unit -> unit
...
type IPopoverProps =
    ...
    abstract content: U2<string, ReactElement> option with get, set
    ...
    abstract target: U2<string, ReactElement> option with get, set
...
type ICollapsibleListProps =
    ...
    abstract visibleItemRenderer: (IMenuItemProps -> float -> ReactElement) with get, set
...
type CollapsibleList =
    inherit IComponent<ICollapsibleListProps, obj>
    abstract displayName: string with get, set
...
type IContextMenuTargetComponent =
    inherit IComponent<obj,obj>
    abstract render: unit -> React.ReactElement option
    abstract renderContextMenu: e: React.MouseEvent -> ReactElement option
...
type Divider =
    inherit IPureComponent<IDividerProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type ControlGroup =
    inherit IPureComponent<IControlGroupProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type IControlProps =
    ...
    abstract onChange: React.FormEventHandler option with get, set
...
type Switch =
    inherit IPureComponent<ISwitchProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type Radio =
    inherit IPureComponent<IRadioProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type Checkbox =
    inherit IComponent<ICheckboxProps, ICheckboxState>
    abstract displayName: string with get, set
    abstract state: ICheckboxState with get, set
    abstract input: obj with get, set
    abstract render: unit -> ReactElement
    abstract componentWillReceiveProps: ICheckboxProps -> unit
    abstract componentDidMount: unit -> unit
    abstract componentDidUpdate: unit -> unit
...
type IFileInputProps =
    inherit React.LabelHTMLAttributes
    inherit IProps
    ...
    abstract onInputChange: React.FormEventHandler option with get, set
    /// The text to display.
    abstract text: React.ReactNode option with get, set

type FileInput =
    inherit IPureComponent<IFileInputProps>
    abstract displayName: string with get, set
...
type FormGroup =
    inherit IPureComponent<IFormGroupProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type IInputGroupProps =
    ...
    abstract leftIcon: U2<IconName, ReactElement> option with get, set
    ...
    abstract rightElement: ReactElement option with get, set
...
type InputGroup =
    inherit IComponent<obj, IInputGroupState>
    abstract displayName: string with get, set
...
type IRadioGroupProps =
    ...
    abstract onChange: (React.FormEvent -> unit) with get, set
...
type TextArea =
    inherit IPureComponent<ITextAreaProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type IHTMLSelectProps =
    ...
    abstract onChange: React.ChangeEventHandler option with get, set
...
type HTMLSelect =
    inherit IPureComponent<IHTMLSelectProps>
    abstract render: unit -> ReactElement
...
type HTMLTable =
    inherit IPureComponent<IHTMLTableProps>
    abstract render: unit -> ReactElement
...
type KeyCombo =
    inherit IComponent<IKeyComboProps, obj>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type IHotkeysTargetComponent =
    ...
    abstract renderHotkeys: unit -> React.ReactElement
...
type MenuDivider =
    inherit IComponent<IMenuDividerProps, obj>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type Menu =
    inherit IComponent<IMenuProps, obj>
    abstract displayName: string with get, set
...
type NavbarDivider =
    inherit IPureComponent<INavbarDividerProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type NavbarGroup =
    inherit IPureComponent<INavbarGroupProps>
    abstract displayName: string with get, set
...
type NavbarHeading =
    inherit IPureComponent<INavbarHeadingProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type Navbar =
    inherit IPureComponent<INavbarProps>
    abstract displayName: string with get, set
    abstract Divider: obj with get, set
...
type NonIdealState =
    inherit IPureComponent<INonIdealStateProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type IOverflowListState<'T> =
    abstract overflow: ResizeArray<'T> with get, set
    abstract visible: ResizeArray<'T> with get, set

type OverflowList<'T> =
    inherit IPureComponent<IOverflowListProps<'T>, IOverflowListState<'T>>
    abstract displayName: string with get, set
    abstract defaultProps: obj with get, set
...
type Text =
    inherit IComponent<ITextProps, ITextState>
    abstract displayName: string with get, set
...
type IPanel<'P> =
    ...
    abstract ``component``: IComponentType<obj> with get, set
...
/// export class SettingsPanel extends IComponent<IPanelProps & ISettingsPanelProps> {...}
/// ```
type IPanelProps =
...
type PanelStack =
    inherit IComponent<IPanelStackProps, IPanelStackState>
...
type Portal =
    inherit IComponent<IPortalProps, IPortalState>
    abstract displayName: string with get, set
...
type ProgressBar =
    inherit IPureComponent<IProgressBarProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type ResizeSensor =
    inherit IPureComponent<IResizeSensorProps>
    abstract displayName: string with get, set
...
type ISliderBaseProps =
    ...
    abstract labelRenderer: U2<bool, (float -> U2<string, ReactElement>)> option with get, set
...
type MultiSlider =
    ...
    abstract displayName: string with get, set
    abstract Handle: React with get, set
    ...
    abstract getLabelPrecision: obj -> unit
...
type Spinner =
    ...
    abstract SIZE_STANDARD: float
    abstract SIZE_LARGE: float
    abstract componentDidUpdate: ISpinnerProps -> unit
    abstract render: unit -> ReactElement
    abstract validateProps:  ISpinnerProps -> unit
...
type ITabsProps =
    ...
    abstract onChange: newTabId: TabId * prevTabId: TabId * ``event``: React.MouseEvent -> unit
...
type Tabs =
    ...
    abstract render: unit -> ReactElement
    abstract componentDidMount: unit -> unit
    abstract componentWillReceiveProps: ITabsProps -> unit
...
type ITagProps =
    ...
    abstract onRemove: (React.MouseEvent -> ITagProps -> unit) option with get, set
...
type Tag =
    inherit IPureComponent<ITagProps>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type ITagInputProps =
    ...
    /// such as `string[]` or `Array<string | ReactElement>`, to match the type of your `values` array:
    /// ```tsx
    /// <TagInput
    ...
    abstract onKeyDown: (React.KeyboardEvent-> float -> unit) option with get, set
    /// Callback invoked when the user releases a keyboard key.
    /// Receives the event and the index of the active tag (or `undefined` if
    /// focused in the input).
    abstract onKeyUp: (React.KeyboardEvent -> float -> unit) option with get, set
...
type IToastProps =
    ...
    abstract message: U2<string, ReactElement> with get, set
...
type ITooltipProps =
    ...
    abstract content: U2<ReactElement, string> with get, set
...
type Tooltip =
    inherit IPureComponent<ITooltipProps>
    abstract displayName: string with get, set
    abstract defaultProps: obj with get, set
    abstract render: unit -> ReactElement
...
type ITreeNode<'T> =
    ...
    abstract label: U2<string, ReactElement> with get, set
    /// A secondary label/component that is displayed at the right side of the node.
    abstract secondaryLabel: U2<string, ReactElement> option with get, set
...
type ITreeNodeProps<'T> =
    ...
    abstract onClick: (TreeNode<'T> -> React.MouseEvent -> unit) option with get, set
    abstract onCollapse: (TreeNode<'T> -> React.MouseEvent -> unit) option with get, set
    abstract onContextMenu: (TreeNode<'T> -> React.MouseEvent -> unit) option with get, set
    abstract onDoubleClick: (TreeNode<'T> -> React.MouseEvent -> unit) option with get, set
    abstract onExpand: (TreeNode<'T> -> React.MouseEvent -> unit) option with get, set
    abstract path: ResizeArray<float> with get, set



and TreeNode<'T> =
    inherit IComponent<ITreeNodeProps<'T>, obj>
    abstract displayName: string with get, set
    abstract render: unit -> ReactElement
...
type TreeEventHandler<'T> =
    [<Emit "$0($1...)">] abstract Invoke: node: ITreeNode<'T> * nodePath: ResizeArray<float> * e: React.MouseEvent -> unit
...
type Tree<'T> =
    inherit IComponent<ITreeProps<'T>, obj>
    abstract displayName: string with get, set
    ...
    abstract ofType: unit -> obj
    abstract nodeFromPath: path: ResizeArray<float> * treeNodes: ResizeArray<ITreeNode<obj>> -> ITreeNode<obj>
